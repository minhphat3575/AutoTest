...
public class TC_006Page extends BasePage {
    ...
    public TC_006Page(WebDriver givenDriver) {
        super(givenDriver);
    ...
    public void clickButtonFind(){
        ...
        WebElement buttonFindElement = findElementByLocator(buttonFind);
        action.sendKeys(buttonFindElement, Keys.ENTER).build().perform();
    }
